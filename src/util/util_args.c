...
/**
 * @brief      Determines if model extensions.
 *
 * @param[in]  filepath  The filepath
 *
...
void print_banner( void ) {
	printf( "\n" );
	printf( "╔═══════════════════════════════════════════════════════════════╗\n" );
	printf( "║         HALF-LIFE MODEL VIEWER - Lambda                       ║\n" );
	...
	printf( "║                                                               ║\n" );
	printf( "║  Use, distribution, and modification of this source code      ║\n" );
	printf( "║  and/or resulting object code is restricted to                ║\n" );
	printf( "║  non-commercial enhancements to products from Valve LLC.      ║\n" );
	printf( "║  All other use, distribution, or modification is              ║\n" );
	printf( "║  prohibited without written permission from Valve LLC.        ║\n" );
	printf( "║                                                               ║\n" );
	printf( "╠═══════════════════════════════════════════════════════════════╣\n" );
